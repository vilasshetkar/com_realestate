...
<div class="span3">
  <ul class="nav menu proj_nav">
      ...
      <li class="item-136"><a href="index.php?option=com_realestate&amp;view=default&amp;layout=search&amp;id=<?php echo $hello["id"]; ?>&amp;project=<?php echo $hello["title"]; ?>">Availability</a></li>
...
<img src="<?php echo $hello["proj_img"]; ?>" alt="<?php echo $hello["title"]; ?>">
</div>
</div>
<div class="span3">
	<div class="project-banner">
		<img src="<?php echo $hello["logo"]; ?>" alt="<?php echo $hello["title"]; ?>">
	</div>
